...
class Watermark(object):
    ...
    def __init__(self, im):
        ...
        self.background_color = settings.CONFIG[
            "watermark"]["background_color"]
        ...
        self.background_opacity = settings.CONFIG[
            "watermark"]["background_opacity"]
        font_path = os.path.join(
            settings.FONTS_ROOT,
            settings.CONFIG["watermark"]["font"])
    ...
    def render(self):
        ...
        self.im = self.put_substrate(
            self.im,
            self.background_color,
            self.background_opacity)
        self.im = self.imprint(
            self.im,
            self.text,
            self.font,
            self.color,
    ...
    def put_substrate(self, im, background_color, opacity):
        ...
        text_box_height = int(
            ...
            self.margin *
            2)
        text_box_width = int(len(self.text) * font_size_px *
                             text_length_multiplier + self.margin)
